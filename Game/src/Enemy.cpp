...
void Enemy::Initialize(Graphics *graphics)
{
	...
	SetVertex(0, /*pos*/-0.3f, 0.3f, 0.3f,  /*color*/ 0.8f, 0.2f, 0.8f, 1.0f);
	SetVertex(1, /*pos*/0.3f, 0.3f, 0.3f,   /*color*/ 0.8f, 0.2f, 0.8f, 1.0f);
	SetVertex(2, /*pos*/-0.3f, -0.3f, 0.3f, /*color*/ 0.8f, 0.2f, 0.8f, 1.0f);
	SetVertex(3, /*pos*/0.3f, -0.3f, 0.3f,  /*color*/ 0.8f, 0.2f, 0.8f, 1.0f);
	SetVertex(4, /*pos*/-0.3f, 0.3f, -0.3f, /*color*/ 0.8f, 0.2f, 0.8f, 1.0f);
	SetVertex(5, /*pos*/0.3f, 0.3f, -0.3f,  /*color*/ 0.8f, 0.2f, 0.8f, 1.0f);
	SetVertex(6, /*pos*/-0.3f, -0.3f, -0.3f,/*color*/ 0.8f, 0.2f, 0.8f, 1.0f);
	SetVertex(7, /*pos*/0.3f, -0.3f, -0.3f, /*color*/ 0.8f, 0.2f, 0.8f, 1.0f);
