...
void Player::Initialize(Graphics *graphics)
{
	...
	SetVertex(0, /*pos*/-0.3f, 0.3f, 0.3f,  /*color*/ 0.5f, 0.0f, 1.0f, 1.0f);
	SetVertex(1, /*pos*/0.3f, 0.3f, 0.3f,   /*color*/ 0.5f, 0.0f, 1.0f, 1.0f);
	SetVertex(2, /*pos*/-0.3f, -0.3f, 0.3f, /*color*/ 0.5f, 0.0f, 1.0f, 1.0f);
	SetVertex(3, /*pos*/0.3f, -0.3f, 0.3f,  /*color*/ 0.5f, 0.0f, 1.0f, 1.0f);
	SetVertex(4, /*pos*/-0.3f, 0.3f, -0.3f, /*color*/ 0.5f, 0.0f, 1.0f, 1.0f);
	SetVertex(5, /*pos*/0.3f, 0.3f, -0.3f,  /*color*/ 0.5f, 0.0f, 1.0f, 1.0f);
	SetVertex(6, /*pos*/-0.3f, -0.3f, -0.3f,/*color*/ 0.5f, 0.0f, 1.0f, 1.0f);
	SetVertex(7, /*pos*/0.3f, -0.3f, -0.3f, /*color*/ 0.5f, 0.0f, 1.0f, 1.0f);
...
{
	_transform.position.x = startX;
	_transform.position.y = startY + CHAR_HEIGHT;
	_transform.position.z = startZ;
}
void Player::Die()
{
	RestartPosition();
